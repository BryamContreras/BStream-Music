...
class AndroidDeviceAudioCatalog implements DeviceAudioCatalog {
  AndroidDeviceAudioCatalog([this._channel = const AndroidLocalMediaChannel()]);

  final AndroidLocalMediaChannel _channel;
